...
def activation_page(workspace_id: str, company: str = "", email: str = "") -> HTMLResponse:
    ...
    defaults = json.dumps(
        {
            ...
            "company": str(company or "").strip()[:240],
